...
/**
 * @brief send data to USART1
 * 
 * @param data  
 * @param length 
 */

// float -> byte (float == 4 byte ) float value =  22.04 ;
// data[12] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C};
// USART1_Send_Data(data, 12);a
